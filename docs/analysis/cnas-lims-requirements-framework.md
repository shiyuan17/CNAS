...
3. 病理、医学检验专属能力不直接纳入通用 17025 基线，作为可选扩展包保留。
4. 未提供实际检测领域、组织规模和现有系统边界前，不固化领域应用说明、审批层级和数据保存期限。

### 本章待确认

- `[待确认]` 本项目仅建设检测实验室能力，还是同时覆盖校准实验室、医学实验室或其他认可制度。
- `[待确认]` 病理科专属功能是否仍属于本次项目范围，或作为后续独立扩展。
- `[待确认]` 最终需求规格说明书是否需要同时交付 Word/PDF 受控版本。
